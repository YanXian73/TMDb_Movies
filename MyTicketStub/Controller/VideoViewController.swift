...
class VideoViewController: UIViewController {
    ...
    func showVideo(currentMovie: MyMovieList){
        var movieVideo = [MovieVideo]()
        guard let url = URL(string: "https://api.themoviedb.org/3/movie/\(currentMovie.id )/videos?api_key=39ba2275337b048cb87893b4520b0c94&language=eu-US") else {return }
